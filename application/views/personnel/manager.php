		...
		<div class="row">
            ...
            <div class="col-sm-5 col-md-3">
                <div class="thumbnail">
                        ...
                        <div class="caption">
                            <p class="text-center">ผศ.ดร.สมเกียรติ ศรีจารนัย</p>
                            <p class="text-center">คณบดี</p>
                        </div>
                    </div>
            </div>
            ...
            <div class="col-sm-5 col-md-3">
                <div class="thumbnail">
                        ...
                        <div class="caption">
                            <p class="text-center">อาจารย์สุมณฑา เกษมวิลาศ</p>
                            <p class="text-center">ผู้ช่วยคณบดีฝ่ายวิชาการ</p>
                        </div>
                    </div>
            </div>
            <div class="col-sm-5 col-md-3">
                <div class="thumbnail">
                        ...
                        <div class="caption">
                            <p class="text-center">ผศ.ดร.วิภู กุตะนันท์</p>
                            <p class="text-center">ผู้ช่วยคณบดีฝ่ายวิชาการ</p>
                        </div>
                    </div>
            </div>
